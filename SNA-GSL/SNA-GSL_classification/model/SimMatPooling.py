...
class SimMatPooling(nn.Module):
    def __init__(self, args):
        ...
        self.cnn_2 = nn.Conv2d(in_channels=args.conv_channels_0,
                               out_channels=args.conv_channels_1, kernel_size=(3, 3))
        self.cnn_3 = nn.Conv2d(in_channels=args.conv_channels_1,
                               out_channels=args.conv_channels_2, kernel_size=(3, 3))
        self.cnn_4 = nn.Conv2d(in_channels=args.conv_channels_2,
                               out_channels=args.conv_channels_3, kernel_size=(3, 3))
