...
from EmbeddingLearning import GCN_layer, MultiHeadAttention_layer, GCNTransformerEncoder
from torch_geometric.nn.glob import global_add_pool, global_mean_pool, global_max_pool
from EmbeddingInteraction import CrossTransformer
...
class Transformer_Coss_Encoder(nn.Module):
    ...
    def __init__(self, args):
        ...
        in_features = self.args.n_max_nodes * self.args.GCA_n_heads
        if self.args.n_max_nodes > self.args.pooling_res:
            in_features = self.args.pooling_res * self.args.GCA_n_heads
...
class TransformerEncoder(nn.Module):
    ...
    def forward(self, G1, G2):
        ...
        mask_1 = G2['mask']
        mask_ij = None
        embeddings_0 = self.embedding_learning(x_0, adj_0, mask_0, None)
        embeddings_1 = self.embedding_learning(x_1, adj_1, mask_1, None)
